...
export const SignupEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>🔐 Confirme sua conta Orphea Core</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Text style={text}>
            Recebemos uma solicitação de criação de conta em nosso sistema.
          </Text>
          <Text style={text}>
            Para ativar sua conta e acessar todos os recursos da plataforma{' '}
          ...
          <Text style={footer}>
            Caso você não tenha realizado este cadastro, ignore esta mensagem.
          </Text>
